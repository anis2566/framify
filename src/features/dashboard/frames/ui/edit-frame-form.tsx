...
import { useUpdateFrame } from "../api/use-update-frame";

interface FrameWithVariants extends Frame {
    variants: FrameVariant[];
}

interface EditFrameFormProps {
    frame: FrameWithVariants;
}

export const EditFrameForm = ({ frame }: EditFrameFormProps) => {
    // MUTATION
    const { mutate: updateFrame, isPending } = useUpdateFrame();
            ...
            <form onSubmit={form.handleSubmit(onSubmit)}>
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Customize your frame</CardDescription>
                    </CardHeader>
